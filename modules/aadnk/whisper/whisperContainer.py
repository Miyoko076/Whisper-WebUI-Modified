...
import torch
import urllib3
from modules.aadnk.hooks.progressListener import ProgressListener

import whisper
from whisper import Whisper

from modules.aadnk.config import ModelConfig, VadInitialPromptMode
from modules.aadnk.hooks.whisperProgressHook import create_progress_listener_handle

from modules.aadnk.modelCache import GLOBAL_MODEL_CACHE, ModelCache
from modules.aadnk.prompts.abstractPromptStrategy import AbstractPromptStrategy
from modules.aadnk.utils import download_file
from modules.aadnk.whisper.abstractWhisperContainer import AbstractWhisperCallback, AbstractWhisperContainer
...
class WhisperContainer(AbstractWhisperContainer):
    ...
    def _get_model_path(self, model_config: ModelConfig, root_dir: str = None):
        from modules.aadnk.conversion.hf_converter import convert_hf_whisper
        """
        Download the model.
